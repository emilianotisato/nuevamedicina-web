...
class Article extends Model implements Feedable, Searchable
{
    use Sluggable;
    ...
    /**
     * Define the SerchResult object
     *
     * @return \Spatie\Searchable\SearchResult
     */
    public function getSearchResult(): SearchResult
    {
        $url = route('article', [$this->category->slug, $this->slug]);
    ...
    {
        return strip_tags(\Str::limit($this->text, 130));
    }
