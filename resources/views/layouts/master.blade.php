        ...
        <div class="row">
            <div class="col-sm-12 top-header">
                ...
                <div class="col-sm-4 social-top">
                    <div id="social">
                        <a href="http://www.facebook.com/nuevamedicinapr" target="_blank"><i class="fa fa-facebook-square"></i> </a>
                        <a href="https://twitter.com/nuevamedicinapr" target="_blank"><i class="fa fa-twitter-square"></i> </a>
                        <a href="http://www.pinterest.com/nuevamedicina" target="_blank"><i class="fa fa-pinterest-square"></i> </a>
                        <a href="https://www.instagram.com/nuevamedicinapr/" target="_blank"><i class="fa fa-instagram"></i> </a>
                    </div>
                </div>
            </div>
            <div class="col-md-12" style="margin-top:25px;">
                <a href="/tienda">
                    <img src="/images/window_shoping.png" alt="Nueva Medicina Shoping"/>
                </a>
            </div>
            <div class="col-md-12">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-sm-8">
                ...
                <div class="credits">
                    Copyright © 2012 - {{ date('Y') }} | Nueva Medicina
                </div>
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="newsletter">
                    <h3>Newsletter</h3>
                    <form action="//nuevamedicina.us15.list-manage.com/subscribe/post?u=0b6a073c0cb9b2a918f47eedb&amp;id=bbad6997a2" method="post">
                ...
                <div class="social">
                    Síguenos:
                    <a href="http://www.facebook.com/nuevamedicinapr" target="_blank"><i class="fa fa-facebook-square"></i> facebook</a>
                    <a href="https://twitter.com/nuevamedicinapr" target="_blank"><i class="fa fa-twitter-square"></i> twitter</a>
                    <a href="http://www.pinterest.com/nuevamedicina" target="_blank"><i class="fa fa-pinterest-square"></i> pinterest</a>
                </div>
...
<div id="mpopupBox" class="mpopup">
    ...
    <div class="mpopup-content">
        <div class="mpopup-head">
            ...
            <img class="logo" src="/images/logos/logo.png" alt="Nueva Medicina"/>
...
<script type="application/ld+json">
{
  ...
  "@type": "WebSite",
  "name": "Nueva Medicina",
  "alternateName": "DISEÑO | DECORACIÓN | ARQUITECTURA | Nueva Medicina",
  "url": "https://www.nuevamedicina.online"
}
</script>
<script type="application/ld+json">
{
  ...
  "url": "https://www.nuevamedicina.online",
  "sameAs": [
    "http://www.facebook.com/nuevamedicinapr",
    "https://twitter.com/nuevamedicinapr",
    "http://www.pinterest.com/nuevamedicina",
