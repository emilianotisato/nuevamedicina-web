...
<head>
    ...
    <title>Nueva Medicina | Panel Administrador</title>

    <meta name="description" content="Nueva Medicina | Panel Administrador">
    <meta name="author" content="nuevamedicina">
...
<div id="login-container" class="animation-fadeIn">
    <div class="login-box">
        ...
        <div class="login-title text-center">
            <h1><img src="/images/logos/logo.png" width="180px"></h1>
        </div>
        <!-- END Login Title -->
