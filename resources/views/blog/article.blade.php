...
@section('meta_keywords'){{ $article->name }}, {{ $article->category->name }}, nueva medicina @endsection

@section('extra_tags')
<meta itemprop="image" content="https://www.nuevamedicina.online/photos/{{ $article->featuredImage()->url }}">
...
<meta property="og:site_name" content="www.nuevamedicina.online"/>
<meta property="og:url" content="{{ Request::url() }}"/>
<meta property="og:image" content="https://www.nuevamedicina.online/photos/{{ $article->featuredImage()->url }}"/>
<meta name="twitter:card" content="summary">
<meta name="twitter:image" content="https://www.nuevamedicina.online/photos/{{ $article->featuredImage()->url }}">
<meta name="twitter:domain" content="www.nuevamedicina.online">
<meta name="twitter:site" content="@nuevamedicinapr">
<meta name="twitter:creator" content="@nuevamedicinapr">
