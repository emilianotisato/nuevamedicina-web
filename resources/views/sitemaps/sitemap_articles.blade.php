...
<urlset
    ...
    <url>
        <loc>https://www.nuevamedicina.online/articulos</loc>
    ...
    @foreach($categories->all() as $category)
        @if($category->articles->count() >= 1)
            <url>
                <loc>https://www.nuevamedicina.online/articulos/{{ $category->slug }}</loc>
            ...
            @foreach($category->articles as $article)
                <url>
                    <loc>https://www.nuevamedicina.online/articulos/{{ $article->category->slug }}/{{ $article->slug }}</loc>
